import { Box, Spinner, Text, Flex, Heading, AspectRatio, IconButton } from '@chakra-ui/react';
...
const LessonBlock = () => {
  ...
  useEffect(() => {
    const fetchLesson = async () => {
      ...
      setError(null);
      try {
        console.log('Fetching lesson for id:', id, 'and lesson_id:', lesson_id); // Log to verify params
